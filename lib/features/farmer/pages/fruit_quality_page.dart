      ...
      return SingleChildScrollView(
          ...
          child: Center(child: ConstrainedBox(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              SfImagePickerCard(
                title: l10n.fruit_image, icon: Icons.apple_outlined,
                analyzeLabel: l10n.analyze_fruit, isLoading: prov.isLoading,
              ...
              if (prov.status == ScanStatus.result && prov.result != null) ...[
                ...
                SfResultCard(title: l10n.analysis_result, children: [
                  SfInfoRow(label: l10n.quality_grade, value: 'Grade ${prov.result!.grade}',
                      valueColor: prov.result!.grade == 'A' ? AppColors.primary
                          : prov.result!.grade == 'B' ? AppColors.warning : AppColors.error),
                  SfInfoRow(label: l10n.grade_label,   value: prov.result!.gradeLabel),
