        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(l10n.system_reports_subtitle, style: AppTextStyles.pageSubtitle),
              ...
              GridView.count(
                ...
                crossAxisSpacing: 16,
                mainAxisSpacing: 16,
                childAspectRatio: MediaQuery.of(context).size.width > 900 ? 2.2 : 1.4,
                children: [
                  _StatCard(
              ...
              LayoutBuilder(builder: (_, c) {
                ...
                final children = [
                  _SectionCard(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _SectionHeader(icon: Icons.bar_chart_rounded, title: l10n.usage_by_service, iconColor: const Color(0xFF10B981)),
                        Text(l10n.total_analyses_per_service, style: AppTextStyles.caption),
                        ...
                        AspectRatio(
                          ...
                          child: Container(
                            ...
                            child: const Center(child: Text('Bar Chart Placeholder', style: AppTextStyles.caption)),
                          ),
                        ),
                      ],
                    ),
                  ),
                  if (!stack) const SizedBox(width: 24) else const SizedBox(height: 16),
                  _SectionCard(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        _SectionHeader(icon: Icons.show_chart_rounded, title: l10n.user_growth, iconColor: const Color(0xFF3B82F6)),
                        Text(l10n.new_user_registrations, style: AppTextStyles.caption),
                        const SizedBox(height: 20),
                        AspectRatio(
                          aspectRatio: 1.5,
                          child: Container(
                            ...
                            child: const Center(child: Text('Line Chart Placeholder', style: AppTextStyles.caption)),
                          ),
                        ),
                      ],
                    ),
                ...
                return stack 
                  ...
                  : Row(crossAxisAlignment: CrossAxisAlignment.start, children: children.map((e) => e is _SectionCard ? Expanded(child: e) : e).toList());
              }),
              const SizedBox(height: 24),
              ...
              _SectionCard(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _SectionHeader(icon: Icons.timeline_rounded, title: l10n.daily_activity, iconColor: const Color(0xFFF59E0B)),
                    Text(l10n.platform_activity_past_week, style: AppTextStyles.caption),
                    const SizedBox(height: 20),
                    AspectRatio(
                      aspectRatio: 3,
                      child: Container(
                        ...
                        child: const Center(child: Text('Full Width Activity Chart Placeholder', style: AppTextStyles.caption)),
                      ),
                    ),
                  ],
                ),
              ...
              _SectionCard(
                child: LayoutBuilder(builder: (_, c) {
                  ...
                  final children = [
                    ...
                    if (stack) const SizedBox(height: 16) else const SizedBox(width: 16),
                    SfPrimaryButton(
                  ...
                  return stack 
                    ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: children.map((e) => e is Expanded ? e.child : e).toList())
...
class _StatCard extends StatelessWidget {
  const _StatCard({required this.svgPath, required this.label, required this.value, required this.trend, required this.iconColor});
