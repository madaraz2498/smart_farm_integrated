            ...
            return Container(
              ...
              child: Theme(
                data: Theme.of(context).copyWith(
                  dividerTheme:
                      const DividerThemeData(color: AppColors.cardBorder),
                ),
                child: DataTable(
                  horizontalMargin: 20,
    ...
    showMenu(
      ...
      items: [
        ...
        PopupMenuItem(
          onTap: () async {
            final ok = u.isActive
                ? await prov.deactivateUser(u.id)
                : await prov.activateUser(u.id);
            _snack(ok
